...
def test_cif_string_decoder_p1() -> None:
    ...
    assert type(N2.cif_string_decoder_p1(N2_str)) == pyStructure
    assert type(Sr.cif_string_decoder_p1(Sr_str)) == pyStructure
    assert type(In.cif_string_decoder_p1(In_str)) == pyStructure
    assert type(Tl.cif_string_decoder_p1(Tl_str)) == pyStructure


def test_cif_string_matcher_p1() -> None:

    assert N2.cif_string_matcher_p1(N2_str) == True
    assert Sr.cif_string_matcher_p1(Sr_str) == True
    assert In.cif_string_matcher_p1(In_str) == True
    assert Tl.cif_string_matcher_p1(Tl_str) == True
