...
class TransformationCallback:
    ...
    @staticmethod
    def translate_single_atom(structure: Structure, max_indices: int = 1, vector: List[float] = [0.25, 0.25, 0.25], seed: int = 42, **kwargs) -> Structure:
        """
    ...
    @staticmethod
    def perturb_structure(structure: Structure, max_distance: float, seed: int = 42, **kwargs) -> Structure:
        """
